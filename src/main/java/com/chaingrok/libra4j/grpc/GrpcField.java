...
public enum GrpcField {
	...
	MAJOR_STATUS("types.TransactionInfo.major_status",Long.class,TransactionInfo.class),
	...
	SIGNED_TXN_BYTES("types.SignedTransaction.signed_txn",ByteString.class,SignedTransaction.class),
	...
	PROOF_NON_DEFAULT_SIBLINGS("types.AccumulatorProof.non_default_siblings",ByteString.class,AccumulatorProof.class),
