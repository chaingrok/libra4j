...
public final class AdmissionControlGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest,
      org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SubmitTransaction",
      requestType = org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest.class,
      responseType = org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest,
      org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod() {
    io.grpc.MethodDescriptor<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest, org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod;
      ...
      synchronized (AdmissionControlGrpc.class) {
        if ((getSubmitTransactionMethod = AdmissionControlGrpc.getSubmitTransactionMethod) == null) {
          AdmissionControlGrpc.getSubmitTransactionMethod = getSubmitTransactionMethod = 
              io.grpc.MethodDescriptor.<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest, org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "admission_control.AdmissionControl", "SubmitTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest.getDefaultInstance()))
  ...
  public static abstract class AdmissionControlImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void submitTransaction(org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest request,
        io.grpc.stub.StreamObserver<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest,
                org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse>(
  ...
  public static final class AdmissionControlBlockingStub extends io.grpc.stub.AbstractStub<AdmissionControlBlockingStub> {
     ...
     * </pre>
     */
    public org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse submitTransaction(org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest request) {
  ...
  public static final class AdmissionControlFutureStub extends io.grpc.stub.AbstractStub<AdmissionControlFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> submitTransaction(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBMIT_TRANSACTION:
          serviceImpl.submitTransaction((org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionRequest) request,
              (io.grpc.stub.StreamObserver<org.libra.grpc.admission_control.AdmissionControlOuterClass.SubmitTransactionResponse>) responseObserver);
          break;
  ...
  private static abstract class AdmissionControlBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.libra.grpc.admission_control.AdmissionControlOuterClass.getDescriptor();
    }
